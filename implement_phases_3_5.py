...
class CSVValidator:
    ...
    @staticmethod
    def validate(listing: ListingRecord) -> Dict:
        ...
        if not listing.condition or listing.condition not in [c.value for c in ConditionEnum]:
        ...
        # Calculate score
        total_checks = len(self.HARD_ERRORS) + len(self.SOFT_WARNINGS)
