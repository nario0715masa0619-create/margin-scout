...
def test_create_job(client, auth_headers_a):
    payload = {"title": "Test Job", "conditions": {"keywords": ["Nintendo"], "sources": ["mercari"], "days_back": 90, "min_sales": 2}}
...
def test_get_jobs_with_data(client, auth_headers_a):
    client.post("/api/v1/research-jobs/", json={"title": "J1", "conditions": {"keywords": ["Nintendo"], "sources": ["mercari"], "days_back": 90, "min_sales": 2}}, headers=auth_headers_a)
    client.post("/api/v1/research-jobs/", json={"title": "J2", "conditions": {"keywords": ["Nintendo"], "sources": ["mercari"], "days_back": 90, "min_sales": 2}}, headers=auth_headers_a)
...
def test_get_job_by_id(client, auth_headers_a):
    create_res = client.post("/api/v1/research-jobs/", json={"conditions": {"keywords": ["Nintendo"], "sources": ["mercari"], "days_back": 90, "min_sales": 2}}, headers=auth_headers_a)
