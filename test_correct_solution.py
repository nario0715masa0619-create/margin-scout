...
inv_payload = {
    "product": {"title": "Correct Test", "description": "Test"},
    "condition": "NEW",
...
# Step 2: Create Offer with ALL required fields for publishing
print("\n[Step 2] Creating Offer with COMPLETE fields...")
offer_url = f"{base_url}/sell/inventory/v1/offer"

# According to eBay docs, these fields are REQUIRED for publishing:
offer_payload = {
    "sku": sku,
    ...
    "categoryId": "27000",
    "listingDescription": "Test product description",
    "tax": {
        "applyTax": False,
...
if offer_response.status_code == 201:
    ...
    print(f"\n[Step 3] Publishing Offer {offer_id} (NO payload)...")
    pub_url = f"{base_url}/sell/inventory/v1/offer/{offer_id}/publish"
    
    # Important: Send POST with NO body
